...
4. **Roadmap Space Account**: You'll need an account at [Roadmap Space](https://roadmap.space/) to get your roadmap ID.
...
## Roadmap Space Integration

This app integrates with [Roadmap Space](https://roadmap.space/) to show your public roadmap within your Shopify admin. To set it up:

1. Create an account at [Roadmap Space](https://roadmap.space/) if you don't have one
2. Create a public roadmap and note your roadmap ID
3. You can either:
   - Copy `.env.example` to `.env` and add your roadmap ID to the `ROADMAP_ID` variable, then restart your app
   - Or directly input your roadmap ID in the app interface in the "Roadmap ID" field

The app provides a simple interface where users can enter:
- Roadmap ID (pre-filled with the default value from environment if available)
- Email address
- First name
- Last name

This information is passed to Roadmap Space to help you track your users.
